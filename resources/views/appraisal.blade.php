...
<body>
    <div class="form-container myform">
        ...
        <div class="title-block">
            ...
            <div class="type">(Supervisor)</div>
        </div>
        <table class="info col-xs-12">
            <tr>
                <th class="col-xs-2">Employee: </th>
                <td><input type="text" class="employee input col-xs-10"></td>
                <th class="col-xs-2">Employment Date: </th>
                <td><input type="date" class="employment-date input col-xs-10" value="<?php echo (new DateTime('-1 year'))->format('Y-m-d'); ?>"></td>
            </tr>
            <tr>
                <th>Employee Number: </th>
                <td><input type="text" class="employee-number input"></td>
                <th>Job Title: </th>
                <td><input type="text" class="job-title input"></td>
            </tr>
            <tr>
            ...
            <tr>
                <th>Supervisor: </th>
                <td><input type="text" class="supervisor input"></td>
            </tr>
        </table>
        <div class="purpose">
        ...
        <table class="performance-category table">
            ...
            <tr><th colspan="12" class="text-center">Leadership</th></tr>
            <tr>
                <td colspan="2">
                    <table class="table col-xs-12">
                        <tr>
                            ...
                            <td><br><br>
                                <div class="slidecontainer">
                                    <input type="range" min="1" max="5" value="3" step="0.5" class="slider23">
                                    <div class="val23"></div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="slidecontainer">
                                    <input type="range" min="1" max="5" value="3" step="0.5" class="slider24">
                                    <div class="val24"></div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="slidecontainer">
                                    <input type="range" min="1" max="5" value="3" step="0.5" class="slider25">
                                    <div class="val25"></div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><br><br>
                                <div class="slidecontainer">
                                    <input type="range" min="1" max="5" value="3" step="0.5" class="slider26">
                                    <div class="val26"></div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><br><br>
                                <div class="slidecontainer">
                                    <input type="range" min="1" max="5" value="3" step="0.5" class="slider27">
                                    <div class="val27"></div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><br><br>
                                <div class="slidecontainer">
                                    <input type="range" min="1" max="5" value="3" step="0.5" class="slider28">
                                    <div class="val28"></div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="slidecontainer">
                                    <input type="range" min="1" max="5" value="3" step="0.5" class="slider29">
                                    <div class="val29"></div>
                                </div>
                            </td>
                        </tr>
                ...
                <td><br>
                    <textarea rows="6" cols="50" class="form-control leadership-memo"></textarea>
                </td>
            </tr>
            <tr>
                <td colspan="2">
