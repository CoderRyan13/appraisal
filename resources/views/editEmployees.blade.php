...
<script>
    ...
    $(document)
                        ...
                        <div class="">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-xl-4">
                                    ...
                                    <input class="form-control department" type='text' id='departmentID' name='department' value="${data[0].department}" readonly/>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-xl-4">
                                    <label>Supervisor Email: </label>
                                    <input class="form-control" type='text' id='supervisorEmail' name='supervisorEmail' value="${data[0].supervisor_email}" readonly/>
                                </div>
                                <div class="col-xl-4">
        ...
        .on('change', '#supervisor', function(e) {
            $('#departmentID').val($('#supervisor option:selected').data('dept'));
